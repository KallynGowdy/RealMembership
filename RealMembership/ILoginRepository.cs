...
namespace RealMembership
{
    ...
    /// </summary>
    public interface ILoginRepository<TAccount>
        where TAccount : UserAccount
    {
        ...
        /// <returns></returns>
        Task<PhoneLogin> GetLoginByPhoneAsync(string tenant, string phoneNumber);
        ...
        /// <returns>Returns an awaitable task that results in the <see cref="PasswordLogin"/> that has the given code.</returns>
        Task<PasswordLogin> GetLoginByResetCodeAsync(string code);

        /// <summary>
        /// Gets the account that has the given ID.
        /// </summary>
        /// <param name="id">The ID of the account that should be retrieved.</param>
        /// <returns>Returns an awaitable task that results in the account that has the given ID.</returns>
        ...
        Task<LoginAttempt> RecordAttemptForLoginAsync(string tenant, string identification, IdentificationType? identificationType, AuthenticationResult result, Login login);
        ...
        Task<PasswordResetAttempt> RecordAttemptForPasswordResetAsync(string tenant, string identification, IdentificationType? identificationType, PasswordResetRequestResult result, PasswordLogin login);
        ...
        /// <param name="login">The specific login that the attempt was against. If null then no login was found.</param>
        /// <returns>Returns the password reset attempt that the information was recorded in.</returns>
        Task<PasswordResetAttempt> RecordAttemptForPasswordResetAsync(string tenant, string identification, IdentificationType? identificationType, PasswordResetFinishResult result, PasswordLogin login);
        ...
        Task<VerificationRequestAttempt> RecordAttemptForLoginVerificationAsync(string tenant, string identification, IdentificationType? identificationType, VerificationRequestResult result, Login login);
        ...
        /// <param name="login">The specific login that the attempt was against. If null then no login was found.</param>
        /// <returns>Returns the verification request attempt that the information was recorded in.</returns>
        Task<VerificationRequestAttempt> RecordAttemptForLoginVerificationAsync(string tenant, string identification, IdentificationType? identificationType, VerificationResult result, Login login);
        ...
        /// <returns></returns>
        Task<Login> GetLoginByVerificationCodeAsync(string code);
    }
}
